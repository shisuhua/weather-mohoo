...
class ViewController: UIViewController,CLLocationManagerDelegate {
    ...
    var pm25data = String()
    var backimage = UIImageView(frame:CGRect(x: 0, y: 0, width: 320, height: 480))
    
    
    override func viewDidLoad() {
        super.viewDidLoad()
        // Do any additional setup after loading the view, typically from a nib.
        LoadingPlayer.hidden = true
            ...
            if data as NSObject == NSNull(){
                ...
                for i in 0..<count_data{
                    if i == 0{
                        ...
                        weatherlabel.frame = CGRectMake(110, 105, 100, 60)
                        
                        
                        if weather.hasPrefix("晴"){
                            self.backimage.image = UIImage(named:"blur_bg0_fine_day.jpg")
                        }else if weather.hasPrefix("阴"){
                            self.backimage.image = UIImage(named:"bg1_cloudy_night.jpg")
                        }else if weather.hasPrefix("多云"){
                            self.backimage.image = UIImage(named:"blur_bg1_cloudy_day.jpg")
                        }else if weather.hasPrefix("小雨"){
                            self.backimage.image = UIImage(named:"bg_rain.jpg")
                        }else if weather.hasPrefix("中雨"){
                            self.backimage.image = UIImage(named:"blur_bg_rain.jpg")
                        }else if weather.hasPrefix("大雨"){
                            self.backimage.image = UIImage(named:"blur_bg_rain.jpg")
                        }else if weather.hasPrefix("阵雨"){
                            self.backimage.image = UIImage(named:"blur_bg_rain_night.jpg")
                        }else if weather.hasPrefix("雷阵雨"){
                            self.backimage.image = UIImage(named:"lightning_1.jpg")
                        }else if weather.hasPrefix("大雾"){
                            self.backimage.image = UIImage(named:"blur_bg_fog_day.jpg")
                        }else if weather.hasPrefix("暴雨"){
                            self.backimage.image = UIImage(named:"blur_bg_thunder_storm.jpg")
                        }else{
                            self.backimage.image = UIImage(named:"blur_bg_fog_day.jpg")
                        }
    ...
    func setupview(){
        ...
        timelabel.frame = CGRectMake(25, 30, 100, 30)
        self.view.addSubview(timelabel)
        
        var citylabel = controlView.createLabelWithTitle(self.currentCity,n: 10)
        citylabel.frame = CGRectMake(25, 45, 100, 35)
        ...
        pm25datalabel.frame = CGRectMake(230, 55, 50, 35)
    ...
    func locationManager(manager: CLLocationManager!, didUpdateLocations locations: [AnyObject]!) {
        ...
        if(location.horizontalAccuracy>0){
            ...
            //self.
            self.countrycity = "\(location.coordinate.longitude+240)" + ",\(location.coordinate.latitude-5.1)"
